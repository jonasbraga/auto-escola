...
INSERT INTO `carros` VALUES (1,'Onix','Chevrolet','Prata','2018','2021-11-27 18:44:29','2021-11-28 22:26:22','HZO-4179'),(2,'Gol','VW','preto','2019','2021-11-27 18:44:38','2021-11-28 22:26:29','LZS-9646'),(3,'Sandero','Renault','Azul','2016','2021-11-27 18:44:53','2021-11-28 22:26:35','MVI-6078'),(4,'Ka','Ford','vermelho','2020','2021-11-27 18:45:12','2021-11-28 22:26:41','NBM-0160');
...
INSERT INTO `cms_menus` VALUES (1,'Salas de aula','Route','AdminSalasControllerGetIndex','normal','fa fa-home',0,1,0,1,1,'2021-11-27 17:01:05','2021-11-27 20:06:28'),(2,'Alunos','Route','AdminAlunosControllerGetIndex','normal','fa fa-heart',0,1,0,1,2,'2021-11-27 17:06:24','2021-11-27 20:06:35'),(3,'Carros','Route','AdminCarrosControllerGetIndex','normal','fa fa-car',0,1,0,1,7,'2021-11-27 18:12:23','2021-11-27 20:06:41'),(6,'Instrutor','Route','AdminFuncionariosControllerGetIndex','normal','fa fa-gear',0,1,0,1,5,'2021-11-27 18:55:21','2021-11-27 20:06:46'),(9,'Aulas','Route','AdminAulasControllerGetIndex','normal','fa fa-clock-o',0,1,0,1,3,'2021-11-27 19:59:59','2021-11-27 20:06:51'),(10,'Motos','Route','AdminMotosControllerGetIndex','normal','fa fa-motorcycle',0,1,0,1,6,'2021-11-28 14:15:27','2021-11-28 14:16:15'),(11,'Exames','Route','AdminExameControllerGetIndex','normal','fa fa-book',0,1,0,1,4,'2021-11-28 14:48:32','2021-11-28 14:49:50'),(12,'Presenças','Route','AdminPresencasControllerGetIndex','normal','fa fa-envelope-o',0,1,0,1,8,'2021-11-28 21:55:29','2021-11-28 21:58:31');
...
INSERT INTO `cms_menus_privileges` VALUES (4,NULL,2),(13,5,1),(15,7,1),(16,8,1),(20,1,3),(21,1,2),(22,1,1),(23,2,3),(24,2,2),(25,2,1),(26,3,3),(27,3,2),(28,3,1),(29,6,3),(30,6,1),(31,9,3),(32,9,2),(33,9,1),(35,10,3),(36,10,2),(37,10,1),(39,11,3),(40,11,2),(41,11,1),(43,12,3),(44,12,2),(45,12,1);
...
INSERT INTO `cms_privileges_roles` VALUES (40,1,1,1,1,1,1,13,NULL,NULL),(41,1,1,1,1,1,1,19,NULL,NULL),(42,1,1,1,1,1,1,14,NULL,NULL),(43,1,1,1,1,1,1,16,NULL,NULL),(44,1,1,1,1,1,1,12,NULL,NULL),(45,1,1,1,1,1,1,4,NULL,NULL),(46,1,1,1,1,1,1,20,NULL,NULL),(60,1,1,1,1,1,1,21,NULL,NULL),(76,1,1,1,1,1,1,22,NULL,NULL),(77,1,1,1,1,1,2,13,NULL,NULL),(78,1,0,1,0,0,2,19,NULL,NULL),(79,1,1,1,1,1,2,14,NULL,NULL),(80,1,0,1,0,0,2,21,NULL,NULL),(81,1,1,1,1,1,2,20,NULL,NULL),(82,1,1,1,1,1,2,22,NULL,NULL),(83,1,1,1,0,0,2,12,NULL,NULL),(84,1,0,1,0,0,2,4,NULL,NULL),(85,1,1,1,1,1,3,13,NULL,NULL),(86,1,1,1,1,1,3,19,NULL,NULL),(87,1,1,1,1,1,3,14,NULL,NULL),(88,1,1,1,1,1,3,21,NULL,NULL),(89,1,1,1,1,1,3,16,NULL,NULL),(90,1,1,1,1,1,3,20,NULL,NULL),(91,1,1,1,1,1,3,22,NULL,NULL),(92,1,1,1,1,1,3,12,NULL,NULL),(93,1,1,1,1,1,3,4,NULL,NULL);
...
INSERT INTO `exame` VALUES (1,'Prático','2021-12-16','10:00','Pista da autoescola',1,'2021-11-28 15:00:48',NULL);
...
INSERT INTO `funcionarios` VALUES (1,'Ronaldo','1990-12-24','masculino','Rua dele','1231','APTO 231','Centro','Cidade','MG','37500-000','11231241245','12408273651','35998453423','Moderado','2021-11-27 19:53:12',NULL,NULL,NULL);
...
CREATE TABLE `motos` (
  ...
  `cor` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ano` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `potencia` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `placa` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `motos` VALUES (1,'Titan','Honda','Vermelha','2018','160cc','2021-11-28 14:27:02','2021-11-28 22:27:48','IAN-6481'),(2,'Fazer','yamaha','preta','2019','150cc','2021-11-28 14:29:35','2021-11-28 22:27:54','KAS-5072'),(3,'factor','yamaha','Azul','2020','125cc','2021-11-28 14:30:15','2021-11-28 22:28:01','JJQ-8736');
...
CREATE TABLE `presencas` (
  ...
  `presente` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `presencas` VALUES (1,1,'Sim','2021-11-28 22:11:53',NULL),(2,2,'Sim','2021-11-28 22:11:56',NULL),(3,3,'Nao','2021-11-28 22:12:00',NULL);
...
-- Dump completed on 2021-11-28 22:29:06
